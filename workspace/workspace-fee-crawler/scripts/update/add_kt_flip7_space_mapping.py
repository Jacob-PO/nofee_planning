...
def add_kt_flip7_space_mapping():
    """KT 플립 7 (띄어쓰기 있음) 매핑 추가"""
    try:
        # Google Sheets 연결
        gc = get_credentials()
        ...
        # 추가할 매핑 - Support 시트의 device_nm
        new_mappings = [
            ("플립 7", "갤럭시 Z 플립 7", "256GB"),  # KT Support의 device_nm (띄어쓰기 있음)
        ]
...
if __name__ == "__main__":
    print("KT 플립 7 (띄어쓰기 있음) 매핑 추가 시작...")
    add_kt_flip7_space_mapping()
    print("\n완료!")