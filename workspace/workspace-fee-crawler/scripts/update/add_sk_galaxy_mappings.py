"""SK Galaxy Z Fold7/Flip7 제품 매핑 추가 스크립트"""
...
def add_sk_galaxy_mappings():
    """SK Galaxy Z Fold7/Flip7 매핑 추가"""
    try:
        # Google Sheets 연결
        gc = get_credentials()
        ...
        # 추가할 SK Galaxy 매핑
        new_mappings = [
            # SK Galaxy Z Fold7 매핑
            ("갤럭시 Z 폴드7 512G", "갤럭시 Z 폴드 7", "512GB"),
            ("갤럭시 Z 폴드7 1T", "갤럭시 Z 폴드 7", "1TB"),
            
            # SK Galaxy Z Flip7 매핑
            ("갤럭시 Z 플립7 512G", "갤럭시 Z 플립 7", "512GB"),
            ("갤럭시 Z 플립7 FE 256G", "갤럭시 Z 플립 7", "256GB"),
        ]
...
if __name__ == "__main__":
    print("SK Galaxy Z Fold7/Flip7 매핑 추가 시작...")
    add_sk_galaxy_mappings()
    print("\n완료!")