...
def update_flip7_to_512gb():
    """플립 7 storage 512GB로 수정"""
    try:
        # Google Sheets 연결
        gc = get_credentials()
        ...
        for i, row in enumerate(all_values):
            ...
            if row[0] == "플립 7" and row[1] == "갤럭시 Z 플립 7":
                ...
                if row[2] != "512GB":
                    ...
                    print(f"✅ storage를 {row[2]}에서 512GB로 수정했습니다.")
                    updated = True
                else:
                    print("이미 512GB입니다.")
...
if __name__ == "__main__":
    print("플립 7 storage를 512GB로 통일...")
    update_flip7_to_512gb()
    print("\n완료!")