...
def add_missing_mappings():
    ...
    try:
        ...
        # 추가할 매핑 - Support 시트에 있는 device_nm들
        new_mappings = [
            # Support 시트에 있는 갤럭시 Z 플립 7 매핑
            ("갤럭시 Z 플립 7 512G", "갤럭시 Z 플립 7", "512GB"),
            ("갤럭시 Z 플립 7 FE 256G", "갤럭시 Z 플립 7 FE", "256GB"),
            
            # Support 시트에 있는 갤럭시 Z 폴드 7 매핑
            ("갤럭시 Z 폴드 7 256G", "갤럭시 Z 폴드 7", "256GB"),
            ("갤럭시 Z 폴드 7 1T", "갤럭시 Z 폴드 7", "1TB"),
            
            # "플립 7", "폴드 7"의 storage를 512GB로 수정해야 하는지 확인
            # 이미 존재하므로 나중에 업데이트
        ]
...
if __name__ == "__main__":
    print("누락된 갤럭시 Z 플립7/폴드7 매핑 추가 시작...")
